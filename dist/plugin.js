...
var eud_default = {
  ...
  entries: [
    ...
    },
    {
      ...
      note: "The name comes from one of the map's strings, shown wherever the unit's name appears. Remastered only. Probe 8 reported other units showing the name too; whether the write reaches more than the one type is being checked.",
      verified: true
    },
    {
      id: "unit.sizeClass",
    ...
    },
    {
      ...
      note: "A write of 250 energy to a placed Ghost did nothing in probe 8 (its maximum is 200 without the upgrade); not yet seen working."
    },
    {
      id: "cunit.owner",
      kind: "both",
